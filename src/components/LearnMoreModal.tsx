...
import { X, Zap, Shield, DollarSign, Users, Star, Clock, Mail, Phone, Award, Trophy, Package, ArrowRight, MessageSquare, Briefcase, GraduationCap, Coffee } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
      <div className="bg-white rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
            ...
            <div className="flex flex-col md:flex-row items-center mb-8">
              <div className="md:w-1/2 md:pr-8">
                ...
                <p className="text-gray-600 mb-4">
                  Hustl was born out of a simple observation: college students are constantly juggling classes, extracurriculars, and social lives, often leaving little time for everyday tasks and errands.
                </p>
                <p className="text-gray-600">
                  Our team of UF students experienced firsthand the challenges of balancing academic responsibilities with daily needs. We created Hustl as a platform where students can help each other, creating a collaborative campus community while making everyone's lives easier.
                </p>
              </div>
              <div className="md:w-1/2 mt-6 md:mt-0">
                <div className="relative rounded-lg overflow-hidden shadow-xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-6">
                    <h4 className="text-white font-bold text-xl">Built By Students, For Students</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-700">
                  A Computer Science major with a passion for solving everyday problems, Kaushal recognized the need for a platform that connects students for quick tasks and errands.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl shadow-md">
                ...
                <p className="text-gray-700">
                  Our diverse team of student developers, designers, and business strategists work together to create a platform that truly understands and addresses the needs of college students.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            <h3 className="text-2xl font-bold text-center mb-8 flex items-center justify-center">
              <Coffee className="w-8 h-8 text-[#0038FF] mr-2" />
